...
<div class="container-fluid">
	<div class="row row3b">
	    <div class=" col-md-offset-1">
			<button class="btn btn-default btn-primary" id="button3" onclick='slidetoggle(this.id,"#add_mentor",2)'>Create Member Account&nbsp&nbsp
			<span class="glyphicon glyphicon-menu-down"</span></button>
		</div>
	</div>
	...
	<form id="adminlogin">
			<!-- ajax call-->
				<div class="form-group col-md-3 col-md-offset-1">
					<input type="text" class="form-control mentor_name" placeholder="Member name" name="mentor_name">
				</div>
